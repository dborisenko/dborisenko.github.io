...
|-----------------------|-----------------------------------------------------------------------|-----------------------------------------------------------|
| InterfaceDeclaration  | An interface declaration declares an interface type.                  | `interface MoverShaker extends Mover, Shaker { <br>getStatus(): { speed: number; frequency: number; }; }`                                                       |

...
| [AmbientVariableDeclaration](https://github.com/Microsoft/TypeScript/blob/f30e8a284ac479a96ac660c94084ce5170543cc4/doc/spec.md#1211-ambient-variable-declarations)    | `declare` `var` AmbientBindingList `;`<br>`declare` `let` AmbientBindingList `;`<br>`declare` `const` AmbientBindingList `;`  |

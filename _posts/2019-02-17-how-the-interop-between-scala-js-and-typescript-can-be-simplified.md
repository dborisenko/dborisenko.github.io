...
|-----------------------|-----------------------------------------------------------------------|-----------------------------------------------------------|
| InterfaceDeclaration  | An interface declaration declares an interface type.                  | `interface MoverShaker extends Mover, Shaker {`{:.typescript}<br>`  getStatus(): { speed: number; frequency: number; };`{:.typescript}<br>`}`{:.typescript}                                                                                           |
